...
def main_worker(args):
    ...
    print('ics begin 5, interval 5 16, lr=0.1-0.01 restart 10 5, lr 15')
    for epoch in range(args.epochs):
        print("learning rate is ", optimizer.param_groups[0]["lr"])
        if epoch not in [21,22,23,24,25]:
            with torch.no_grad():
        ...
        if epoch == 20:
            ...
            if args.optimizer == 'AdamW':
                ...
                optimizer = torch.optim.SGD(params, lr=0.0004, momentum=0.9, weight_decay=args.weight_decay)
